<nav class="sidebar sidebar-offcanvas" id="sidebar">
    <div class="sidebar-brand-wrapper d-none d-lg-flex align-items-center justify-content-center fixed-top">
        <a class="sidebar-brand brand-logo" href="{{ route('home') }}"><img src="{{ asset('images/logo-mini.png') }}"
                alt="logo" /></a>
        <a class="sidebar-brand brand-logo-mini" href="{{ route('home') }}"><img src="{{ asset('images/logo-mini.png') }}"
                alt="logo" /></a>
    </div>
    <ul class="nav">
        ...
        @if ($user->hasRole(['super.admin', 'manegar', 'employee', 'user']))
            <li class="nav-item menu-items {{ Route::is("reliver.*") ? 'active' : ''}}">
                <a class="nav-link" href="{{ route('reliver.index') }}">
                    ...
                    <span class="menu-title">Reliver</span>
                </a>
            </li>
        @endif
